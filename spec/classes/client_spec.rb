...
describe 'simp_openldap::client' do
  on_supported_os.each do |os, os_facts|
    context "on #{os}" do
      ...
      ldap_conf_content = {
        default:           "URI                 ldap://server1.host.net ldap://server2.host.net\n" \
                           "BASE                DC=host,DC=net\n" \
        ...
        with_strip_128_bit_ciphers:           "URI                 ldap://server1.host.net ldap://server2.host.net\n" \
                                              "BASE                DC=host,DC=net\n" \
                                              "BINDDN              cn=hostAuth,ou=Hosts,DC=host,DC=net\n" \
                                              "REFERRALS           on\n" \
                                              "SIZELIMIT           0\n" \
        ...
        without_strip_128_bit_ciphers:           "URI                 ldap://server1.host.net ldap://server2.host.net\n" \
                                                 "BASE                DC=host,DC=net\n" \
                                                 "BINDDN              cn=hostAuth,ou=Hosts,DC=host,DC=net\n" \
                                                 "REFERRALS           on\n" \
                                                 "SIZELIMIT           0\n" \
        ...
        with_crlfile:           "URI                 ldap://server1.host.net ldap://server2.host.net\n" \
                                "BASE                DC=host,DC=net\n" \
                                "BINDDN              cn=hostAuth,ou=Hosts,DC=host,DC=net\n" \
                                "REFERRALS           on\n" \
                                "SIZELIMIT           0\n" \
        ...
        without_tls:           "URI                 ldap://server1.host.net ldap://server2.host.net\n" \
                               "BASE                DC=host,DC=net\n" \
                               "BINDDN              cn=hostAuth,ou=Hosts,DC=host,DC=net\n" \
                               "REFERRALS           on\n" \
                               "SIZELIMIT           0\n" \
      ...
      ldaprc_content = {
        default:           "# This file placed by Puppet, but may be modified\n" \
                           "#\n" \
        ...
        with_crlfile:           "# This file placed by Puppet, but may be modified\n" \
                                "#\n" \
                                "# If you need a fresh copy, simply delete the file and Puppet will regenerate\n" \
                                "# it\n\n" \
                                "TLS_CACERTDIR /etc/pki/simp_apps/openldap/x509/cacerts\n" \
      ...
      context 'Generates files with strip_128_bit_ciphers = true' do
        ...
        it_behaves_like 'a ldap config generator'
      end

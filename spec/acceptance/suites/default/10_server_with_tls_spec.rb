    ...
    context "simp_openldap::server #{server}" do
      ...
      context 'with tls enabled' do
        ...
        context 'LDAP server configuration' do
          ...
          it 'configures server with tls enabled and with no errors' do
          ...
          it_behaves_like 'a tls enabled system'
        end

        context 'with a new set of PKI certificates' do
          it 'populates new certificates into simp-testing' do
          ...
          it 'reconfigures LDAP server with new certs' do
            apply_manifest_on(server, server_manifest, catch_failures: true)
          end

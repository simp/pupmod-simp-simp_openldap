    ...
    context "client with tls  when LDAP server #{server}" do
      ...
      clients.each do |client|
        context "client #{client} configuration" do
          ...
          it 'should configure client with tls and with no errors' do
        ...
        context 'connection to the LDAP server' do
          it 'should be able to connect using TLS' do
            ...
            expect(result.output).to match(/dn: uid=test\.user,ou=People,/)
          end
        end
      end
    end
